...
const NAV = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" className="w-[18px] h-[18px]">
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      {/* ── Sidebar ── */}
      <aside className="w-[240px] bg-slate-950 flex flex-col fixed inset-y-0 left-0 z-20 shadow-2xl">
        {/* Brand */}
        <div className="px-5 py-5 border-b border-white/5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-white text-sm font-bold tracking-tight leading-none">Nessa Luxe</p>
        ...
        <div className="px-3 py-4 border-t border-white/5">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.6} stroke="currentColor" className="w-[18px] h-[18px] text-slate-500">
